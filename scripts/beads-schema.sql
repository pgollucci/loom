-- Beads Dolt schema initialization
-- Creates the beads database and all required tables
-- Source: github.com/steveyegge/beads internal/storage/dolt/schema.go
...
-- Views for ready and blocked issue queries
...
-- Commit the schema
CALL dolt_add('-A');
CALL dolt_commit('-m', 'Initialize beads schema');
